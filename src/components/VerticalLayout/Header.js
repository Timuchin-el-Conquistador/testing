...
import logod from "../../assets/images/murmur.png";
import logoLightPng from "../../assets/images/logo-light.png";
import logoLightSvg from "../../assets/images/murmuricon.png";
              ...
              <div className="navbar-brand-box">
                <Link to="/" className="logo logo-dark">
                  ...
                  <span className="logo-lg">
                    <img src={logoDark} alt="Hello" height="17" />
                  </span>
                </Link>
                ...
                <Link to="/" className="logo logo-light">
                  ...
                  <span className="logo-lg">
                    <img src={logod} alt="" height="55" width="170" />
                  </span>
                </Link>
              </div>
